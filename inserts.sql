INSERT INTO `departments` (`id`, `name`) VALUES (NULL, 'Finanzas');
INSERT INTO `departments` (`id`, `name`) VALUES (NULL, 'Recursos Humanos');
...
INSERT INTO `types_of_users` (`id`, `name`) VALUES (NULL, 'Operación');
INSERT INTO `types_of_users` (`id`, `name`) VALUES (NULL, 'Configuración');

INSERT INTO `approvals` (`id`, `status`, `create_time`) VALUES (NULL, '1', '2020-07-06 20:01:31');